...
class SettingDbStoreTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $name = Yii::$app->setting->get('db.name');
    ...
    {
        $success = Yii::$app->setting->set('db.name', 'new title');
        $this->assertTrue($success);
